...
class TLDetector(object):
    ...
    def image_cb(self, msg):
        ...
        if self.state != state:
            ...
            # We're only interested in red traffic lights
    ...
    def get_closest_waypoint(self, x, y):
        ...
        Args:
            x (float): first coordinate of a point
            y (float): second coordinate of a point
    ...
    def get_light_state(self, light):
        ...
        rospy.logwarn('Light detection: %d %d', light.state, light_state)
        return light_state
